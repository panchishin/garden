...
words = [ 'lily','rose','hydrangea','kalanchoe','hibiscus','begonia','hosta','iris','coleus','maple','geranium','peony','azalea','aloe','orchid','ivy','sedum','petunia','dracaena','dahlia','dianthus','virginia','bromeliad','japonica','magnolia','pothos','oak','schefflera','clematis','creeper','rhododendron','cyclamen','fern','jade','lantana','dieffenbachia','daisy','tulip','cactus','croton','columbine','celosia','ficus','hyacinth','yucca','salvia','canna','euphorbia','japanese','poppy','violet','palm','strawberry','camellia','oxalis','impatiens','dogwood','phlox','glory','spathiphyllum','allium','vera','vinca','amaryllis' ]
