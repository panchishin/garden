...
class cnn :
  def __init__( self, num_classes , image_size=128 , embedding_size=128 ) :
    ...
    stages.append( layer.resnet_block( stages[-1] , 16, 3 , training=self.training, momentum=0.99, name="16" ) )
    ...
    stages.append( layer.resnet_narrow( stages[-1] , 128, 3 , training=self.training, narrowing=4, momentum=0.99, name="128_2" ) )
    # 8
    stages.append( layer.resnet_downscale( stages[-1] ) )
    stages.append( layer.resnet_narrow( stages[-1] , 256, 3 , training=self.training, narrowing=8, momentum=0.99, name="256_1" ) )
    stages.append( layer.resnet_narrow( stages[-1] , 256, 3 , training=self.training, narrowing=8, momentum=0.99, name="256_2" ) )
    # 16
    stages.append( layer.resnet_downscale( stages[-1] ) )
    stages.append( layer.resnet_narrow( stages[-1] , 512, 3 , training=self.training, narrowing=16, momentum=0.99, name="512_1" ) )
    stages.append( layer.resnet_narrow( stages[-1] , 512, 3 , training=self.training, narrowing=16, momentum=0.99, name="512_2" ) )
    # 32
